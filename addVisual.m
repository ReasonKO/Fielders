...
if isfield(exp1_data,'Setka_h');
    ...
    setPlotData(exp1_data.p_h,X(in1),Y(in1));
    setPlotData(exp1_data.p_h2,X(in2),Y(in2));
    setPlotData(exp1_data.d_h3,robot.p(1)+robot.d(1),robot.p(2)+robot.d(2));
    setPlotData(exp1_data.d_h4,robot.C(1),robot.C(2));
    setPlotData(exp1_data.d_h5,robot.p(1)+Kc(:,1),robot.p(2)+Kc(:,2));
